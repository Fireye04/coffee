...
description: A primer on various TTRPG systems targetted at the average 5e player. 
categories:
- blog
blog-tags:
- default
...
We just simply don't have the same level of narrative control that other artistic mediums do, however, what we have, that they don't, is a direct line of communication with the player directly: mechanics.
So, we put a living shit ton of work into making arrays of mechanics that perfectly build towards our thesis, as that's how we convey artistic vision in place of raw narrative.
...
And I'm especially talking to the RP-focused 5e groups out there that simply just don't run combat. Or do so very infrequently. 
...
As a baseline, all the non-combat is a design afterthought compared to combat, which is what the system was made for! 
